...
/* ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
   DATA
ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */
// Kiwi.com CDN serves airline logos reliably by IATA code ΓÇö no CORS issues
...
const POPULAR_ROUTES = [
  { from: "Delhi",   to: "Mumbai",    img: "https://images.unsplash.com/photo-1529253355930-ddbe423a2ac7?w=400&q=80", duration: "2h 15m", price: "Γé╣3,499", tag: "Most Popular" },
  { from: "Mumbai",  to: "Goa",       img: "https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?w=400&q=80", duration: "1h 05m", price: "Γé╣3,199", tag: "Beach Escape" },
  { from: "Delhi",   to: "Bangalore", img: "https://images.unsplash.com/photo-1596176530529-78163a4f7af2?w=400&q=80", duration: "2h 45m", price: "Γé╣5,299", tag: "Tech Hub" },
  { from: "Mumbai",  to: "Bangalore", img: "https://images.unsplash.com/photo-1580019542155-247062e19ce4?w=400&q=80", duration: "1h 40m", price: "Γé╣4,199", tag: "Business" },
  { from: "Chennai", to: "Hyderabad", img: "https://images.unsplash.com/photo-1599661046289-e31897846e41?w=400&q=80", duration: "1h 10m", price: "Γé╣2,999", tag: "Quick Hop" },
  { from: "Kolkata", to: "Delhi",     img: "/kolkata.png", duration: "2h 30m", price: "Γé╣4,799", tag: "Classic Route" },
];
...
const TRAVEL_TIPS = [
  { img: "https://images.unsplash.com/photo-1435527173128-983b87201f4d?w=400&q=80", tip: "Book 6ΓÇô8 weeks early for domestic flights to get the best rates." },
  { img: "https://images.unsplash.com/photo-1551525212-a1dc18bef82c?w=400&q=80", tip: "Travel light ΓÇö most budget carriers charge for check-in baggage." },
  ...
  { img: "https://images.unsplash.com/photo-1512152596508-05e811c7594b?w=400&q=80", tip: "Carry snacks ΓÇö budget airlines often serve meals at a premium." },
];
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4">
        <p className="text-white font-extrabold text-base leading-tight drop-shadow">
          {route.from} ΓåÆ {route.to}
        </p>
        <div className="flex items-center gap-3 mt-1">
          <span className="text-xs text-white/80 font-medium">ΓÅ▒ {route.duration}</span>
    ...
    <div className="flex items-center justify-between bg-white dark:bg-slate-900 rounded-2xl px-5 py-4 shadow-sm border border-gray-100 dark:border-slate-800 mb-6 transition-colors">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-slate-400">{source} ΓåÆ {destination}</p>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen pb-12 transition-colors duration-300 bg-slate-50 dark:bg-slate-950">
      ...
      <div className="relative overflow-hidden" style={{ minHeight: 400 }}>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 pt-20 pb-12">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-5 text-xs text-white/70 font-medium">
            {["≡ƒöÆ Secure Payment", "Γ£à 8 Airlines", "ΓÜí Instant Booking", "≡ƒÄº 24/7 Support"].map((b) => (
              <span key={b}>{b}</span>
            ))}
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pb-20 mt-8">
        ...
        {/* ΓöÇΓöÇ SEARCH RESULTS ΓöÇΓöÇ */}
        {searched && (
          <>
            <StatsBar count={loading ? "ΓÇª" : flights.length} source={source} destination={destination} onClear={clearSearch} />
            ...
            {!loading && flights.length > 0 && (
              <div>
                ...
                <div className="flex items-center gap-2 mb-4 overflow-x-auto pb-1">
                  ...
                  {["Price Γåæ", "Duration", "Departure"].map((f) => (
        ...
        {/* ΓöÇΓöÇ PRE-SEARCH CONTENT ΓöÇΓöÇ */}
        {!searched && (
          <>
            {/* Popular Routes */}
            ...
            <section className="mb-12 rounded-3xl overflow-hidden relative" style={{ height: 260 }}>
              ...
              <div className="absolute inset-0 flex flex-col justify-center px-10">
                ...
                <p className="text-blue-100 text-sm max-w-xs">
                  From the beaches of Goa to the mountains of Himachal ΓÇö we fly you there.
                </p>
              </div>
            </section>
